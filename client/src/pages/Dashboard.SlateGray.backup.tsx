...
export default function Dashboard() {
  ...
  return (
    <AppLayout>
      <div className="w-full min-h-full bg-gradient-to-br from-slate-50 via-gray-50/50 to-zinc-50/30">
        {/* Hero Header */}
        <div className="bg-gradient-to-br from-slate-950 via-slate-800 to-slate-600 text-white shadow-xl">
                ...
                <div className="flex flex-col gap-2 mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="flex-1 h-9 px-4 bg-gradient-to-r from-slate-700 to-slate-900 hover:from-slate-800 hover:to-slate-950 text-white text-sm"
                    >
                ...
                <CardContent className="p-4">
                  <div className="text-center">
                    <div className="relative inline-flex items-center justify-center w-24 h-24 mb-2">
                      ...
                      <span className="absolute text-xl font-bold text-slate-600">
